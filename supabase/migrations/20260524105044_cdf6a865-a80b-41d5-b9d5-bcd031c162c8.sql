...
CREATE TABLE IF NOT EXISTS public.users (
  ...
  free_revives_used_today INT NOT NULL DEFAULT 0,
  paid_revives_used_today INT NOT NULL DEFAULT 0,
  last_revive_reset_date DATE,
  free_plays_used_today INT NOT NULL DEFAULT 0,
  paid_plays_used_today INT NOT NULL DEFAULT 0,
  bonus_free_revives INT NOT NULL DEFAULT 0
);
...
CREATE TABLE IF NOT EXISTS public.levels (
  ...
  gravity NUMERIC NOT NULL DEFAULT 0.5,
  jump_strength NUMERIC NOT NULL DEFAULT -8,
  scroll_speed NUMERIC NOT NULL DEFAULT 2.5,
  pipe_gap INT NOT NULL DEFAULT 220,
  bg_color TEXT DEFAULT '#0a0a0a',
  enabled BOOLEAN NOT NULL DEFAULT true,
  weight INT NOT NULL DEFAULT 1,
  repeat_loop BOOLEAN NOT NULL DEFAULT false,
  reward_per_coin NUMERIC NOT NULL DEFAULT 1,
  prize_gtc NUMERIC NOT NULL DEFAULT 10,
  free_revives INT NOT NULL DEFAULT 2,
  paid_revive_base NUMERIC NOT NULL DEFAULT 100,
  paid_revive_multiplier NUMERIC NOT NULL DEFAULT 2,
  paid_revive_limit INT NOT NULL DEFAULT 1000,
...
CREATE TABLE IF NOT EXISTS public.game_sessions (
  ...
  coins_pending INT NOT NULL DEFAULT 0,
  coins_credited INT NOT NULL DEFAULT 0,
  revives_used INT NOT NULL DEFAULT 0,
  paid_revives_used INT NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS public.transactions (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  user_id BIGINT NOT NULL REFERENCES public.users(telegram_id) ON DELETE CASCADE,
  kind TEXT NOT NULL CHECK (kind IN ('deposit','game_reward','referral_bonus','admin_adjust','revive_spend','level_prize','powerup_spend','play_fee','play_refund','level_skip')),
  amount_gtc NUMERIC(20,4) NOT NULL,
...
INSERT INTO public.admins (telegram_id, role) VALUES (5574348933, 'main')
